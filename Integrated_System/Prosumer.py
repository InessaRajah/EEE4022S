...
class Prosumer:
    def __init__(self, agent, partners, preferences, rho):
        ...
        # Model variables
        self.batt_discharge_cost = expando()
        self.batt_charge_cost = expando()
    ...
    def _opti_status(self,trade):
        ...
        self.batt_discharge_cost = self.data.a[3]*self.variables.p[3].x + self.data.b[3]
        self.batt_charge_cost = self.data.a[0]*self.variables.p[0].x + self.data.b[0]
        return
